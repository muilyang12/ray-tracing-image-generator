...
`)+`
`+x);const H=V+M+p,P=V+x+m,Y=Qv(l,l.VERTEX_SHADER,H),I=Qv(l,l.FRAGMENT_SHADER,P);l.attachShader(C,Y),l.attachShader(C,I),i.index0AttributeName!==void 0?l.bindAttribLocation(C,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(C,0,"position"),l.linkProgram(C);function k(q){if(s.debug.checkShaderErrors){const rt=l.getProgramInfoLog(C).trim(),dt=l.getShaderInfoLog(Y).trim(),_t=l.getShaderInfoLog(I).trim();let Mt=!0,X=!0;if(l.getProgramParameter(C,l.LINK_STATUS)===!1)if(Mt=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,C,Y,I);else{const st=$v(l,Y,"vertex"),tt=$v(l,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(C,l.VALIDATE_STATUS)+`
